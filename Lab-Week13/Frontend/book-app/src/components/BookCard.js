...
function BookCard({ book, onEdit, onDelete }) {
  ...
  return (
    <div className="group bg-gradient-to-br from-white via-white to-blue-50 p-6 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 border-2 border-gray-100 hover:border-blue-300 transform hover:-translate-y-2 hover:scale-[1.02]">
      ...
      <div className="flex items-start justify-between mb-4">
        <div className="flex-1">
          <div className="flex items-center gap-3 mb-3">
            ...
            <h3 className="text-xl font-bold text-gray-800 leading-tight group-hover:text-blue-700 transition-colors">
              {book.name}
            </h3>
          </div>

          {/* Penulis dengan Icon */}
          <div className="flex items-center gap-2 text-gray-600 mb-4 ml-1">
      ...
      {/* Tanggal dengan Icon dan Background */}
